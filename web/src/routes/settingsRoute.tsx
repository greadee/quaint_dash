import { Aperture, Gauge, ListFilter, Palette } from "lucide-react";
  ...
  return <div className="page">
    ...
    <section className="settings-grid">
      <article className="card settings-card">
        <div className="settings-card-heading"><span className="settings-card-icon"><Aperture size={18} /></span><div><p className="eyebrow">Appearance</p><h2>Theme</h2></div></div>
      ...
      <article className="card settings-card">
        <div className="settings-card-heading"><span className="settings-card-icon"><ListFilter size={18} /></span><div><p className="eyebrow">Overview</p><h2>Movers list</h2></div></div>
      ...
      <article className="card settings-card">
        <div className="settings-card-heading"><span className="settings-card-icon"><Gauge size={18} /></span><div><p className="eyebrow">Data surfaces</p><h2>Density</h2></div></div>
      ...
      <article className="card settings-card">
        <div className="settings-card-heading"><span className="settings-card-icon"><Palette size={18} /></span><div><p className="eyebrow">Feature color</p><h2>Accents</h2></div></div>
