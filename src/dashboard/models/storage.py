...
from dashboard.models.commands import AnalyticsCommands, BrokerCommands, IngestionCommands
...
class DashboardManager(AnalyticsCommands, BrokerCommands, IngestionCommands):
    """
